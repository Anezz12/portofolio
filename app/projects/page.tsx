...
const projects = [
  ...
  },
  {
    ...
    description: "AI-powered chat application with real-time messaging and smart features.",
    technologies: ["Next.js", "Socket.io", "OpenAI", "Redis"],
  ...
  },
  {
    ...
    description: "Analytics dashboard for monitoring application performance.",
